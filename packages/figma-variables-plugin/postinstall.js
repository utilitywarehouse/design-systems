...
const eslintPluginSrc = path.resolve(__dirname, '../../node_modules/@figma/eslint-plugin-figma-plugins');
const eslintPluginDest = path.resolve(__dirname, './node_modules/@figma/eslint-plugin-figma-plugins');
