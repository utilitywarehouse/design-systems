...
import { transitions, colors } from '@utilitywarehouse/customer-ui-design-tokens';
...
import { ButtonProps as MuiButtonProps, ExtendButton } from '@mui/material/Button';
...
const InteractiveCardComponent = React.forwardRef(function InteractiveCardComponent(
...
const InteractiveCard = React.forwardRef(function InteractiveCard({ forwardedRef, ...props }, ref) {
  ...
  const { backgroundColor } = useBackground();
  const interactiveCardBackgroundColor = backgroundColor === 'white' ? 'purple' : 'white';

  return (
    <BackgroundProvider backgroundColor={props.backgroundColor || interactiveCardBackgroundColor}>
