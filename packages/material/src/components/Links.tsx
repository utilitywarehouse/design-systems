...
export type CustomLinkProps<D extends React.ElementType = defaultComponent, P = {}> = Omit<
  MuiLinkTypeMap<P, D>['props'],
  'color' | 'underline'
>;
...
export type LinkProps<D extends React.ElementType = defaultComponent, P = {}> = OverrideProps<
  LinkTypeMap<D, P>,
  D
>;
...
interface NavLinkTypeMap<D extends React.ElementType = defaultComponent, P = {}> {
  props: CustomNavLinkProps<D, P>;
  defaultComponent: D;
}

export type NavLinkProps<D extends React.ElementType = defaultComponent, P = {}> = OverrideProps<
  NavLinkTypeMap<D, P>,
  D
>;
