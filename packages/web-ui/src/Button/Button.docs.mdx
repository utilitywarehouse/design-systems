...
<DocsHeader componentName="Button" stories={Stories} themeProviderRequired />

This component will be replaced with the `lab/Button` component in a future major release.
