...
import type { GridProps as MuiGridProps } from '@mui/system/Unstable_Grid';
 ...
 *
 * This component is based on the `@mui/system` Grid component, except it
 * adheres to our custom breakpoints, and has default spacing & columns.
 *
 * Please [check the MUI site for further documentation](https://mui.com/system/react-grid/).
 */
