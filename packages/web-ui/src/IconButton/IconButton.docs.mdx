...
<Flex gap={2} align="center">
  <IconButton variant="solid" label="continue">
    <ChevronRightMediumIcon />
  </IconButton>
  <IconButton variant="outline" label="continue">
    <ChevronRightMediumIcon />
  </IconButton>
  <IconButton variant="ghost" label="continue">
    <ChevronRightMediumIcon />
  </IconButton>
</Flex>
```
...
```tsx
<IconButton colorScheme="cyan" label="continue">
```
...
const MyComponent = () => {
  ...
  return (
    <IconButton size={{ mobile: 'small', desktop: 'medium' }} label="continue">
...
```tsx
import { IconButton, Box } from '@utilitywarehouse/web-ui';
import { ChevronRight01MediumIcon, ChevronRight01SmallIcon } from '@utilitywarehouse/react-icons';
