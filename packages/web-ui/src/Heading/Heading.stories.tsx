...
type WorkshopStoryArgs = typeof Heading & { background: BoxProps['background'] };
type WorkshopStory = StoryObj<WorkshopStoryArgs>;

export const HeadingWorkshop: WorkshopStory = {
  name: 'Workshop',
  render: args => {
    return (
      <Stack spacing={0}>
