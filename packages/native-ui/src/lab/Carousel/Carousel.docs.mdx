...
import { Alert, Box, Center, Text } from '../../';
...
<Meta title="Lab Components / Carousel" />
...
The `CarouselPagination` component automatically receives props from the parent `Carousel` component. Please ensure that you always wrap the `CarouselPagination` component within the `Carousel` component.
