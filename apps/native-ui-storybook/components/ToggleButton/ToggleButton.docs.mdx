      ...
      <Box width="100%" maxWidth={400}>
        <ToggleButtonGroup value="option1">
          <ToggleButton value="option1">
            ...
            <ToggleButtonText style={{ color: 'red' }}>Option 1</ToggleButtonText>
          </ToggleButton>
          <ToggleButton value="option2">
            <ToggleButtonIcon as={StarMediumIcon} />
            <ToggleButtonText style={{ color: 'blue' }}>Option 2</ToggleButtonText>
          </ToggleButton>
          <ToggleButton value="option3">
            <ToggleButtonIcon as={EnvironmentMediumIcon} />
            <ToggleButtonText style={{ color: 'green' }}>Option 3</ToggleButtonText>
          </ToggleButton>
        </ToggleButtonGroup>
      </Box>
    </Center>
