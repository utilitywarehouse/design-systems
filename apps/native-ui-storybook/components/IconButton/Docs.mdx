...
import ViewStorybookButton from '../../docs/components/ViewStorybookButton';

<Meta of={ButtonStories} />

<ViewStorybookButton url="https://www.figma.com/design/3RY3OvLA88yZksRjOfjQJm/UW-App-UI?node-id=1746-4235" />
