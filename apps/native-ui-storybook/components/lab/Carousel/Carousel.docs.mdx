...
<DocComponentWrap>
  ...
  <Box mb="$6">
    <Alert
      colorScheme="gold"
      text="The carousel is a specific implementation of FlatList. Some props cannot be modified. This is to ensure standardised behaviour and presentation."
    />
  </Box>
</DocComponentWrap>
...
| ---------------------- | --------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------ |
| children?              | ReactNode                               | -       | Display any content within the carousel context. This may include `CarouselPagination`.                                        |
...
| renderItem             | (info: ListRenderItemInfo) => ReactNode | -       | Method used to render each item in the carousel                                                                                |
