...
<Canvas>
  <NativeUIProvider>
    <Center>
      <Checkbox value="Label" onChange={checked => console.log(checked, '###')}>
        <CheckboxIndicator />
...
const MyComponent = () => {
  ...
  return (
    <Checkbox value="accepted" onChange={(checked: boolean) => setAccepted(checked)}>
      <CheckboxIndicator />
      <CheckboxLabel>I accept the terms and conditions</CheckboxLabel>
    </Checkbox>
  );
...
<Canvas>
  <NativeUIProvider>
    <Center>
      <Checkbox value="Label" onChange={() => console.log(checked, '###')}>
        <CheckboxIndicator />
...
const MyComponent = () => {
  ...
  return (
    <Checkbox value="subscribed" onChange={(checked: boolean) => setSubscribed(checked)}>
      <CheckboxIndicator />
      <CheckboxLabel>Subscribe</CheckboxLabel>
    </Checkbox>
  );
