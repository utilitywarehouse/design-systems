...
**Note:** The `ButtonIcon` component should when using [advanced usage](#advanced-usage) with the `Button` component.
Prefer the `icon` prop on the `Button` component for simple usage.
...
**Note:** The `ButtonText` component should when using [advanced usage](#advanced-usage) with the `Button` component.
...
**Note:** The `Spinner` component should when using advanced usage with the `Button` component.
Prefer the `loading` prop on the `Button` component for simple usage.
