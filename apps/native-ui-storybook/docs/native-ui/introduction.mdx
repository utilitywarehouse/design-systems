...
```console
yarn add @utilitywarehouse/colour-system @utilitywarehouse/react-native-icons react-native-svg@14.1.0 react-native-reanimated@3.6.3
```
...
and [react-native-reanimated](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/getting-started) documentation.
...
If you are using Expo, you can use the `expo-font` package to load the fonts.
