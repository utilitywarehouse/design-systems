...
<ColorPalette>
  ...
  <ColorItem
    ...
    colors={common['brand'].reduce((acc, key) => {
      acc[key.name.replace('$brand', '').charAt(0).toLowerCase() +
                      key.name.replace('$brand', '').slice(1)] = key.value;
      return acc;
    }, {})}
  />
  <ColorItem
    ...
    colors={common['service'].reduce((acc, key) => {
      acc[key.name.replace('$service', '').charAt(0).toLowerCase() +
                      key.name.replace('$service', '').slice(1)] = key.value;
      return acc;
    }, {})}
  />
</ColorPalette>
